// To parse this data:
//
//   import { Convert, YoutubeModel } from "./file";
//
//   const youtubeModel = Convert.toYoutubeModel(json);
//
...
export class Convert {
  public static toYoutubeModel(json: string): YoutubeModel {
    return cast(JSON.parse(json), r("YoutubeModel"));
  }

  public static youtubeModelToJson(value: YoutubeModel): string {
    return JSON.stringify(uncast(value, r("YoutubeModel")), null, 2);
  }
}
